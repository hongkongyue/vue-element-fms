        ...
        <Modal
            ...
            <div>
                <Upload
                        ...
                        :data="{account:userInfo.userAccount,userId:userInfo.userId,importType:'DLJ'}"
                >
    ...
    export default {
        ...
        methods: {
            ...
            get_order_list() {
                ...
                this.request('get_dalingjia_order_list', {
                    data: dataMap
                }, true).then(res => {
                    if (res.code == 1) {
            ...
            get_shop_list() {
                this.request('get_dalingjia_shop_list', {
                    data:{
                        orderType:'DLJ'
                    }
                }, true).then(res => {
            ...
            get_lives_list(shopId) {
                this.request('get_dalingjia_lives_list', {
                    data:{
                        shopId:shopId
                    }
                }, true).then(res => {
