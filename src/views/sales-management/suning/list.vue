        ...
        <Modal
            ...
            <div>
                <Upload
                        ...
                        :data="{account:userInfo.userAccount,userId:userInfo.userId,importType:'SNTM'}"
                >
    ...
    export default {
        ...
        methods: {
            ...
            get_order_list() {
                ...
                this.request('get_sntm_order_list', {
                    data: dataMap
                }, true).then(res => {
                    if (res.code == 1) {
            ...
            get_shop_list() {
                this.request('get_sntm_shop_list', {
                    data:{
                        orderType:'SNTM'
                    }
                }, true).then(res => {
            ...
            get_lives_list(shopId) {
                this.request('get_sntm_lives_list', {
                    data:{
                        shopId:shopId
                    }
                }, true).then(res => {
