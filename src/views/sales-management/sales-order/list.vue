...
<template>
    <div class="background-color-white exhibition">
        ...
        <Row class-name="margin-bottom-10">
            <Col span="24" class="">
            <Button type="primary" @click="resend_order">
                重新推送
            </Button>
        ...
        <Modal
            ...
            <div>
                <Upload
                        ...
                        :data="{account:userInfo.userAccount,userId:userInfo.userId,importType:'AKC'}"
                >
