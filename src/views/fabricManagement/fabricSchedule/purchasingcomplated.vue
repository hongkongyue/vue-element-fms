    ...
    <div>
        ...
        <Row :style="{minHeight:showBink?'830px':'620px'}" class="background-color-white exhibition">
            ...
            <el-table-column prop="realMaterial" label="是否有实物" min-width="90" align="center" show-overflow-tooltip>
                 <template slot-scope="scope">
                           {{scope.row.realMaterial ? (scope.row.realMaterial==1?'是':'否') : ''}}
                </template>
            </el-table-column>
            <el-table-column prop="contrastColor" label="是否撞色" min-width="150" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
                           {{scope.row.contrastColor? (scope.row.contrastColor==1?'是':'否') : ''}}
                </template>
            </el-table-column>
            ...
            <el-form :inline="true" ref="ruleForm" :model="formData" class="demo-form-inline demo-ruleForm " :label-position="left" :rules="rules">
                ...
                <Col>
                    <el-form-item label="门幅(cm)：" size="small" label-width="115px" prop="fabricWidth">
                        <el-input  v-model="formData.fabricWidth"  style="width:160px"  show-word-limit ></el-input>
                    </el-form-item>
                    <el-form-item label="克重(g/m2)：" size="small" label-width="125px" prop="fabricWeight">
                        <el-input v-model="formData.fabricWeight" style="width:160px" ></el-input>
                    </el-form-item>
                 ...
                 <Col>
                    <el-form-item label="成分:" size="small" label-width="115px" prop="ingredient">
                           <el-input v-model="formData.ingredient" style="width:160px" ></el-input>
                    </el-form-item>
                    <el-form-item label="起订量：" size="small" label-width="115px" prop="moq">
                       <el-input v-model="formData.moq" style="width:160px" ></el-input>
                    </el-form-item>
                     <el-form-item label="默认损耗(%)：" size="small" label-width="125px" prop="loss">
                        <el-input  v-model="formData.loss"   style="width:170px"  show-word-limit></el-input>
                    </el-form-item>
                </Col>
                  <Col>
                    <el-form-item label="纬缩(%):" size="small" label-width="120px" >
                            <el-input v-model="formData.loopedWeft" style="width:155px" ></el-input>
                    </el-select>
                    </el-form-item>
                    <el-form-item label="经缩(%):" size="small" label-width="120px" >
                           <el-input v-model="formData.knees" style="width:165px" ></el-input>
                    </el-form-item>
                     <el-form-item label="生产周期：" size="small" label-width="115px" >
                        <el-input  v-model="formData.productCycle"   style="width:170px"  show-word-limit></el-input>
                    </el-form-item>
                </Col>
                 <Col>
                    <el-form-item label="订货周期:" size="small" label-width="115px" >
                           <el-input v-model="formData.orderCycle" style="width:160px" ></el-input>
                    </el-form-item>
                    <el-form-item label="公斤米数:" size="small" label-width="115px" >
                           <el-input v-model="formData.kilogramsOfRice" style="width:160px" ></el-input>
                    </el-form-item>
                     <el-form-item label="备注：" size="small" label-width="125px">
                        <el-input  v-model="formData.remark"   style="width:170px"  show-word-limit></el-input>
                    </el-form-item>
                </Col>
              ...
              search(){
                ...
                submitRecord(){
                    ...
                    let data={}
                        ...
                        data.taskNo=taskNo
                        data.taskConfigurationId=this.list[0]?this.list[0].taskConfigurationId:''
                        data.askConfigurationName=this.list[0]?this.list[0].taskConfigurationName:''
                        data.basicSupplierId=this.formData.basicSupplierId
                        ...
                        data.fabricWidth=this.formData.fabricWidth
                        data.fabricWeight=this.formData.fabricWeight
                        data.unit=this.formData.unit
                        data.ingredient=this.formData.ingredient
                        data.moq=this.formData.moq
                        //缺少
                        data.loss=this.formData.loss;
                        data.knees=this.formData.knees
                        data.loopedWeft=this.formData.loopedWeft
                        data.productCycle=this.formData.productCycle
                        data.orderCycle=this.formData.orderCycle
                        data.kilogramsOfRice=this.formData.kilogramsOfRice
