  ...
  <div>
    <header class="headerstyle">
      <el-form :inline="true" :model="formSearch" class="demo-form-inline">
        ...
        <el-form-item label="加工项目：" size="small">
          <el-input v-model="formSearch.processProject" placeholder="请输入"></el-input>
        </el-form-item>
    ...
    <section class="middle" style="padding-top:10px" :style="{minHeight:showBink?'680px':'480px'}">
      ...
      >
        ...
        <el-table-column prop="processProject" label="加工项目" min-width="120" align="center">
    ...
    >
      <Row class="margin-bottom-10 background-color-white exhibition">
        ...
        >
          <!-- <Col> -->
            <el-form-item label="加工项目" size="small" label-width="95px" prop="processProject">
            <!--   <el-input  v-model="formData.supplierName" maxlength="20" style="width:120px"></el-input> -->
             <el-input
                type="text"
                v-model="formData.processProject"
                maxlength="1000"
                placeholder="请输入"
                style="width:380px"
              ></el-input>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        processProject: [
          { required: true, message: "请输入加工项目", trigger: "blur" }
        ],
        startTime: [
  ...
  methods: {
    ...
    getLoglist(billNo) {
      ...
      let data = {};
      data.billNo = "mark_change_process_project_record_" + this.billNo;
      data.pageSize = 3;
    ...
    getData() {
      ...
      !!this.formSearch.processProject?data.processProject = this.formSearch.processProject:delete data.processProject;
      this.request("discount_markChangeProcessProject_query_page", data, true).then(
        res => {
          if (res.code == 1) {
    ...
    addBrand() {
      let data = {};
      data.processProject = this.formData.processProject;
      this.request("discount_markChangeProcessProject_add", data, true).then(res => {
        if (res.code == 1) {
          this.$message({
            message: "新增成功",
            type: "success"
    ...
    editBrand() {
      ...
      data.processProject = this.formData.processProject;
      this.request("discount_markChangeProcessProject_update", data, true).then(
        res => {
          if (res.code == 1) {
            this.$message({
              message: "编辑成功",
