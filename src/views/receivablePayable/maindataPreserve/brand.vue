...
<div>
    ...
    <section class="middle" :style="maxHeight">
        ...
        <el-table @selection-change="selection" @select-all="selection" @select="selection" ref="multipleTable" :data="list" style="width: 100%" class="pointer" border tooltip-effect="dark" max-height="250" @row-click="showLog" highlight-current-row>
            ...
            <el-table-column prop="code" label="品牌编码" min-width="120" align="center">
                <!-- <template slot-scope="scope">{{ scope.row.date }}</template> -->
            </el-table-column>
            <el-table-column prop="name" label="品牌名称" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="omsBrandCode" label="OMS品牌编码" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="omsBrandName" label="OMS品牌名称" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="shortName" label="品牌缩写" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="dropName" label="吊牌显示名称" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            ...
            <el-table-column prop="warehouseName" label="成品仓库" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="costMultiplying" label="成本倍率" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="soPriceTail" label="零售价尾数" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="companyName" label="公司名称" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="companyAddress" label="公司地址" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="companyPhone" label="公司电话" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="containsTrialFee" label="含试制费" min-width="120" align="center" show-overflow-tooltip>
            ...
            <el-table-column prop="scmBrandId" label="SCM_ID" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="scmBrandCode" label="SCM品牌编码" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="scmBrandName" label="SCM品牌名称" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="groups" label="组别" min-width="120" align="center" show-overflow-tooltip>
            </el-table-column>
        </el-table>

         <div style="width:100%;font-size:16px;margin-top:10px">操作日志</div>
    ...
    methods: {
        ...
        onEdit() {
            if (this.IDS.length == 1) {
                ...
                this.addformdata.companyName = this.IDS[0].basicCompanyId
                ...
                this.addformdata.omsBrandCode = this.IDS[0].omsBrandCode
                this.addformdata.omsBrandName = this.IDS[0].omsBrandName
                this.addformdata.scmBrandCode = this.IDS[0].scmBrandCode
                this.addformdata.scmBrandId = this.IDS[0].scmBrandId
                this.addformdata.scmBrandName = this.IDS[0].scmBrandName
                this.addformdata.groups = this.IDS[0].groups
        ...
        addBrand() {
            ...
            data.omsBrandCode = this.addformdata.omsBrandCode
            data.omsBrandName = this.addformdata.omsBrandName
            data.scmBrandCode = this.addformdata.scmBrandCode
            data.scmBrandId = this.addformdata.scmBrandId
            data.scmBrandName = this.addformdata.scmBrandName
            data.groups = this.addformdata.groups
