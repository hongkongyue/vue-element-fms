      ...
      getButtonJurisdiction(){
        ...
        this.request('masterData_resource_buttonResource', data, true).then(res => {
          ...
          confirmSub(){
               ...
               if(this.addList.length>0){
                  ...
                  this.request('received_accReceivedPeriod_addBatch', arr, true).then((res) => {
                            if (res.code == 1) {
         ...
         getData(){
                ...
                let data={}
                    ...
                    this.request('received_accReceivedPeriod_commonQuery', data, true).then((res) => {
                            if (res.code == 1) {
                                  this.list      =  res.data
        ...
        confirm(){
         ...
         getLoglist(billNo){
                     ...
                     this.currentPage=1
                    let data={}
                        data.billNo     =filters.getConstant('time')+ this.billNo
                        data.pageSize   =3
