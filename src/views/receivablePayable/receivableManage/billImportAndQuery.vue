...
<div>
    ...
    <Modal :mask-closable="false" v-model="dialogVisible" :styles="mystyle" @on-cancel="importCancel" title="导入账单" :width="450" class-name="customize-modal-center">
        <Row class="margin-bottom-10 background-color-white exhibition">
            <el-form :rules="rules" ref="ruleForm" :model="ruleForm" class="demo-ruleForm " :label-position="left">
                ...
                <el-form-item label="平台：" prop="code" label-width="120px" size="small">
                    <el-select :disabled="disabledYun" v-model="ruleForm.code" @change="changePT(ruleForm.code)" filterable placeholder="请选择" style="width:150px">
                ...
                <el-form-item label="平台模式：" prop="ptms" label-width="120px" size="small">
                    <el-select v-model="ruleForm.ptms" @change="changePtms(ruleForm.ptms)" filterable placeholder="请选择" style="width:150px">
                ...
                <el-form-item label="账单模式：" prop="zdms" label-width="120px" size="small">
                    <el-select v-model="ruleForm.zdms" @change="changeZdms(ruleForm.zdms)" filterable placeholder="请选择" style="width:150px">
                ...
                <el-form-item label="账单类型：" prop="address" label-width="120px" size="small">
                    <el-select v-model="ruleForm.address" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in zlList" :key="item" :label="item" :value="item"></el-option>
                    </el-select>
                </el-form-item>
                </Col>

                <Col span="24" v-if="ruleForm.resource">
                <el-form-item label="公司：" prop="name" label-width="120px" size="small">
                    <el-select v-model="ruleForm.name" @change="changeName(ruleForm.name)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in companyCodeOptions" :key="item.name" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
                ...
                <el-form-item label="店铺：" prop="shortName" label-width="120px" size="small">
                    <el-select v-model="ruleForm.shortName" @change="changeDP(ruleForm.shortName)" filterable placeholder="请选择" style="width:150px">
                ...
                <Col span="24" v-if="ruleForm.resource == '通用格式'">
                <el-form-item label-width="70px">
    ...
    <Modal :mask-closable="false" v-model="dialogTwoVisible" :styles="mystyle" @on-cancel="importTwoCancel" title="账单处理" :width="450" class-name="customize-modal-center">
        <Row class="margin-bottom-10 background-color-white exhibition">
            <el-form :rules="rules" ref="ruleFormA" :model="ruleFormA" class="demo-ruleForm " :label-position="left">
              ...
              <el-form-item label="导入格式：" label-width="120px"  prop="resource">
                ...
                <Col span="24">
                <el-form-item label="平台：" prop="code" label-width="120px" size="small">
                    <el-select v-model="ruleFormA.code" @change="changePT(ruleFormA.code)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in platformOptions" :key="item.name" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
                ...
                <el-form-item label="平台模式：" prop="ptmsTwo" label-width="120px" size="small">
                    <el-select v-model="ruleFormA.ptmsTwo" @change="changePtmsTwo(ruleFormA.ptmsTwo)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in PTList" :key="item" :label="item" :value="item"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
                ...
                <el-form-item label="账单模式：" prop="zdmsTwo" label-width="120px" size="small">
                    <el-select v-model="ruleFormA.zdmsTwo" @change="changeZdmsTwo(ruleFormA.zdmsTwo)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in ZDList" :key="item" :label="item" :value="item"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
                ...
                <Col span="24">
                <el-form-item label="账单类型：" prop="address" label-width="120px" size="small">
                    <el-select v-model="ruleFormA.address" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in zlList" :key="item" :label="item" :value="item"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
                ...
                <el-form-item label="公司：" prop="name" label-width="120px" size="small">
                    ...
                    <el-select v-model="ruleFormA.name" @change="changeName(ruleFormA.name)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in companyCodeOptions" :key="item.name" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="店铺：" prop="shortName" label-width="120px" size="small">
                    ...
                    <el-select v-model="ruleFormA.shortName" @change="changeDP(ruleFormA.shortName)" filterable placeholder="请选择" style="width:150px">
                        <el-option v-for="item in shopList" :key="item.name" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </el-form-item>
                </Col>
