...
export default {
  ...
  data() {
    return {
      ...
      rules          : {
                        ...
                        postponeDay1: [
                          { required: true, message: "请输入减值率", trigger: "blur" },
                          // { pattern: /^[1-9]\d*(\.\d+)?$/i, message: "输入值大于0" ,trigger: "blur"}
                        ],
                        postponeDay2: [
                          { required: true, message: "请输入减值率", trigger: "blur" },
                          // { pattern: /^[1-9]\d*(\.\d+)?$/i, message: "输入值大于0" ,trigger: "blur"}
  ...
  methods: {
    ...
    confirmeAdd(){
               const{taskId,postponeDay1,postponeDay2,postponeDay3,postponeDay4,postponeDay5}=this.formData
              let data={}
                  data.taskId      =taskId
