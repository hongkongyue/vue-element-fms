...
<div>
    ...
    <section class="middle" :style="maxHeight">
        ...
        <plx-table-grid :data="list" border style="width: 100%" :height="oneTableHeight" :row-class-name="tableRowClassName" @row-click="clickRow" :summary-method="getSummaries" show-summary :pagination-show="false" :row-key="String(Math.random(1,100000))">
            <plx-table-column type="index" width="80" label="序号" resizable fixed="left" align="center" />
            <plx-table-column prop="basicBrandName" sortable min-width="95" resizable fixed="left" label="品牌" align="center" />
            <!-- <plx-table-column prop="designerDelay" min-width="95" resizable fixed="left" label="设计师下单延期" align="center" /> -->
            <plx-table-column v-for="v in columns" :key="v.label" sortable :prop="v.prop" resizable min-width="95" :label="v.label" align="center" />
        </plx-table-grid>
        ...
        <el-tabs v-model="activeName" style="margin-top:10px" type="card" @tab-click="handleClick">
            <el-tab-pane label="明细" name="first">
                <plx-table-grid :data="detailData" style="width: 100%" border tooltip-effect="dark" :height="twoTableHeight" size="mini">
                    ...
                    <plx-table-column prop="designNo" label="设计款号" sortable  resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="designer" label="设计师" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstLevel" label="一级品类" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="secondLevel" label="二级品类" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="thirdLevel" label="三级品类" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="developType" label="SCM开发类型" sortable resizable min-width="130" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="factoryName" label="外发工厂" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="designDate" label="设计稿日期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="fillingDate" label="建档日期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="photoDate" label="拍照日期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="planDelay" label="规划延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="fillingDelay" label="建档延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstSimpleCreateDelay" label="头版样衣指令延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstSimpleFinishDelay" label="头版样衣完成延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="secondSimpleCreateDelay" label="二版样衣指令延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="secondSimpleFinishDelay" label="二版样衣完成延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="thirdSimpleCreateDelay" label="三版样衣指令延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="thirdSimpleFinishDelay" label="三版样衣完成延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="pricingDelay" label="开发核价延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="designerDelay" label="设计师下单延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="bigPricingDelay" label="核价延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="produceDelay" label="生产下单延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="simpleCreateDelay" label="齐色样样衣指令延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="simpleFinishDelay" label="齐色样样衣完成延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="developCostPrice" label="规划品类开发成本" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="totalContractPrice" label="总合约单价" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="costPrice" label="税前成本价" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstColorQty" label="首单下单色数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstQty" label="首单下单数量" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="firstAmount" label="首单下单金额" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="purchaseDelay" label="入库延期天数" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="unPurchaseQty" label="未入库数量" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="purchaseRate" label="入库率" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="purchaseDifferenceQty" label="入库差异" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="outdoorPhotoDelay" label="外拍图片延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="outdoorVideoDelay" label="外拍视频延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="stillLifePhotoDelay" label="静物图片延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="planningLaunchDelay" label="可上新状态延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="launchDelay" label="上新延期" sortable resizable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
...
export default {
    ...
    methods: {
        ...
        getHeaderList() {
            ...
            data.pageResourceCode = "delay-page"
        ...
        getData() {
            ...
            data.paramMap.basicBrandName = this.formSearch.basicBrandId
            data.paramMap.groups = this.formSearch.group
            data.paramMap.season = this.formSearch.season
            data.paramMap.waveBand = this.formSearch.waveBand
            data.paramMap.secondLevel = this.formSearch.secondLevel
            data.paramMap.developType = this.formSearch.developStatus
            data.paramMap.years = this.formSearch.years
            this.columns.map((i) => {
                propList.push(i.prop)
            })
            data.dimensionProps = propList
            this.request('goodsFollow_delayAnalysis', data, true).then(res => {
                if (res.code == 1) {
        ...
        onExport(){
            ...
            data.dimensionProps = propList
            this.request('delayAnalysis_allPages', data, true).then(res => {
                if (res.code == 1) {
                    if (res.data) {
        ...
        let filename = '延期天数分析' + myDate.toLocaleString()
        ...
        clickRow(row){
            ...
            data.paramMap.developType = this.formSearch.developStatus
            data.paramMap.years = this.formSearch.years
            this.request('goodsFollow_delayAnalysisDetail', data, true).then(res => {
                if (res.code == 1) {
