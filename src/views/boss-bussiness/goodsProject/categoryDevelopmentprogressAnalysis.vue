        ...
        <!-- {{columns}} -->
            ...
            <el-tab-pane label="明细" name="first">
                <plx-table-grid :data="listDetail" style="width: 100%;" border   tooltip-effect="dark"  :height="twoTableHeight" size="mini">
                    ...
                    <plx-table-column prop="basicBrandName" label="品牌" sortable min-width="120" align="center" show-overflow-tooltip>
                    ...
                    <plx-table-column prop="secondLevel"          label="二级品类" sortable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="developCostPrice" label="品类开发成本" sortable min-width="120" align="center" show-overflow-tooltip>
                     ...
                     <plx-table-column prop="developStyleQty" label="计划开发款数" sortable min-width="120" align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="producePostponeDay" label="生产下单延期天数" min-width="120" sortable align="center" show-overflow-tooltip>
                    </plx-table-column>
                    ...
                    <plx-table-column prop="simpleFinishPostponeDay" label="拍摄样完成延期天数" min-width="120" sortable align="center" show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="unPricingStyleQty" label="大货未核价款数" min-width="120" align="center" sortable show-overflow-tooltip>
                    </plx-table-column>
                    <plx-table-column prop="orderTotalAmount" label="规划开发金额" min-width="120" align="center" sortable show-overflow-tooltip>
