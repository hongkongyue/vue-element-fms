<template>
  <div>
    <header class="headerstyle" style="width:99%">
            ...
            <el-form-item label="规划日期：" size="small">
             ...
             <el-form-item label="品牌：" size="small">
              ...
              <el-form-item label="部门：" size="small">
                <el-select v-model="formSearch.departmentId" placeholder="请选择" style="width:150px" filterable clearable>
             ...
             <el-form-item label="任务类型：" size="small">
              ...
              <section class="middle" style="padding-top:10px" :style="{minHeight:showBink&&showhidden?'750px':'650px'}">
                  <el-pagination
                  ...
                  >
                    ...
                    <el-table-column type="index" width="105" label="序号"   align="center"></el-table-column>
                   ...
                   <div slot="append">
                                ...
                                <div class='sum_footer heji'>
                                         ...
                                         <div v-for="v in  column " :key="v"   class='sum_footer_unit center  el-table_1_column_6  adjust   is-center is-leaf'>
                                                  ...
                                                  <div v-else-if="v=='delayAmount'" style="text-align:right;padding-right:10px">
                                                    <!-- {{totalObj.delayAmount|moneyFilters}} -->
                    ...
                    <section class="log">
                      <el-table :data="logList" style="width: 100%" border tooltip-effect="dark" max-height="250">
                        ...
                        <el-table-column   prop="basicBrandName"  label="品牌" min-width="120" align="center" show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column  prop="waveBand" label="波段" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column  prop="firstLevel" label="一级品类" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                          <el-table-column prop="secondLevel" label="二级品类" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column  prop="thirdLevel" label="三级品类" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="designNo" label="设计款号" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                        <el-table-column prop="taskName" label="任务类型" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                          <el-table-column prop="userName" label="员工" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="departmentName" label="部门" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                        <el-table-column prop="planFinishDate" label="规划完成日期" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="actualStartDate" label="实际开始时间" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="actualFinishDate" label="实际完成时间" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="actualUseDays" label="实际使用天数" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="delayDays" label="延期天数" align="center" min-width="120" show-overflow-tooltip>
                        </el-table-column>
                         <el-table-column prop="delayAmount" label="计费费用" align="center" min-width="120" show-overflow-tooltip>
                                 <template slot-scope="scope"> 
                                    <div style="text-align:right">{{scope.row.delayAmount|moneyFilters}}</div> 
                                </template>
                        </el-table-column>
...
export default {
  ...
  methods: {
      ...
      onExportExcel(){
        const{planFinishDateStart,planFinishDateEnd,taskId,basicBrandId,departmentId,userId}=this.formSearch
        this.logList = [];
        let data = {};
      ...
      timeFormat(date) {
       ...
       etFirstDayOfMonth (date) {
        ...
        getTaskList(){
           this.request('boss_goods_planning_manage_constant',{type:'planning_delay_task_type'},false).then(res=>{
                       if(res.code==1){
    ...
    getDetail(id){
          this.request('boss_bossDelayCostDetail_getDetails',{detailIds:id},false).then(res=>{
             if(res.code==1){
