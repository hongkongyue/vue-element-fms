    ...
    children: [
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/fabricQuality.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/developType.vue"),
        hidden: false,
      },
      {
        path: "wavedand",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/wavedand.vue"),
        hidden: false,
      },
      {
        path: "year",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/year.vue"),
        hidden: false,
      },
      {
        path: "season",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/season.vue"),
        hidden: false,
      },
      {
        path: "styleType",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/styleType.vue"),
        hidden: false,
      },
      {
        path: "payConfig",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/payConfig.vue"),
        hidden: false,
      },
      {
        path: "unitFile",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/unitFile.vue"),
        hidden: false,
      },
      {
        path: "colorFile",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/colorFile.vue"),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/materialTypeFile.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/discount.vue"),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/supplierProfile.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/businessType.vue"),
        hidden: false,
      },
      {
        path: "shop",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/shop.vue"),
        hidden: false,
      },
      {
        path: "log",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/log.vue"),
        hidden: false,
      },
      {
        path: "publishLog",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/publishLog.vue"),
        hidden: false,
      },
      {
        path: "platform",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/platform.vue"),
        hidden: false,
      },
      {
        path: "brandbuy",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/brand.vue"),
        hidden: false,
      },
      {
        path: "encodeingRules",
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/encodeingRules.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/staff.vue"),
      },
      {
        path: "company",
        title: "公司",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/company.vue"),
        hidden: false,
      },
      {
        path: "financialType",
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/financialType.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/receivableManage/businessAccount.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/receivableManage/billImportAndQuery.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/receivableManage/receivables.vue"),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/receivableManage/accountingAmount.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/receivableManage/reconciliations.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/receivableManage/receivableTimeManage.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import("@/views/receivablePayable/receivableManage/receipt.vue"),
        hidden: false,
      },
      {
        path: "verification",
        ...
        component: () =>
          import("@/views/receivablePayable/receivableManage/verification.vue"),
        hidden: false,
      },
      {
        path: "billType",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/billType.vue"),
        hidden: false,
      },
      {
        path: "departmentFMS",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/department.vue"),
        hidden: false,
      },
      {
        path: "post_Preserve",
        ...
        component: () =>
          import("@/views/receivablePayable/maindataPreserve/post.vue"),
        hidden: false,
      },
      {
        path: "customer_list",
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/receivablePayable/maindataPreserve/modifyProject.vue"
          ),
        hidden: false,
      },
      {
    ...
    children: [
      {
        ...
        component: () => import("@/views/privilege/role/list.vue"),
        hidden: false,
      },
      {
        path: "add__role",
      ...
      },
      {
        ...
        component: () => import("@/views/privilege/role/edit.vue"),
        hidden: true,
      },
      {
        path: "new_user_list",
        ...
        component: () => import("@/views/privilege/user/list.vue"),
        hidden: false,
      },
      {
        path: "new_user_edit",
        ...
        component: () => import("@/views/privilege/user/edit.vue"),
        hidden: true,
      },
      {
        ...
        component: () => import("@/views/privilege/resources/list.vue"),
        hidden: false,
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import("@/views/stockCenter/mainData/warehouse.vue"),
        hidden: false,
      },
      {
        path: "historical",
        ...
        component: () => import("@/views/stockCenter/business/historical.vue"),
        hidden: false,
      },
      {
        path: "timely",
        ...
        component: () => import("@/views/stockCenter/business/timely.vue"),
        hidden: false,
      },
      {
        path: "inStockOrder",
      ...
      },
      {
        ...
        component: () => import("@/views/stockCenter/business/outStock.vue"),
        hidden: false,
      },
      {
        path: "inStock",
        ...
        component: () => import("@/views/stockCenter/business/inStock.vue"),
        hidden: false,
      },
      {
        path: "otherInStock",
      ...
      },
      {
        ...
        component: () => import("@/views/stockCenter/business/salesOutlet.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/stockCenter/business/purchaseAndWarehousingError.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/stockCenter/business/stockTaking.vue"),
        hidden: false,
      },
      {
        path: "noSingerReturn",
      ...
      },
      {
        ...
        component: () => import("@/views/stockCenter/business/adjustStock.vue"),
        hidden: false,
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import("@/views/payableManage/business/deduction.vue"),
        hidden: false,
      },
      {
        path: "static",
        ...
        component: () => import("@/views/payableManage/business/static.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/payableManage/business/scmOrder.vue"),
        hidden: false,
      },
      {
        path: "customs",
        ...
        component: () => import("@/views/payableManage/business/customs.vue"),
        hidden: false,
      },
      {
        path: "wareHouse",
        ...
        component: () => import("@/views/payableManage/business/wareHouse.vue"),
        hidden: false,
      },
      {
        path: "checkBill",
        ...
        component: () => import("@/views/payableManage/business/checkBill.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/payableManage/business/test.vue"),
        hidden: false,
      },
      {
        path: "chart",
    ...
    children: [
      {
        ...
        component: () => import("@/views/costDiscount/revision.vue"),
        hidden: false,
      },
      {
        path: "returnRecord",
        ...
        component: () => import("@/views/costDiscount/returnRecord.vue"),
        hidden: false,
      },
      {
        path: "costReduction",
        ...
        component: () => import("@/views/costDiscount/costReduction.vue"),
        hidden: false,
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () =>
          import("@/views/supplierPrivilege/position/position_list.vue"),
        hidden: false,
      },
      {
        path: "staff_list",
        ...
        component: () =>
          import("@/views/supplierPrivilege/staff/staff_list.vue"),
        hidden: false,
      },
      {
        path: "resource_list",
        ...
        component: () =>
          import("@/views/supplierPrivilege/menu/resource_list.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import("@/views/supplierPrivilege/business/vop_taskConfig.vue"),
        hidden: true,
      },
      {
        path: "question",
        ...
        component: () =>
          import("@/views/supplierPrivilege/business/question.vue"),
        hidden: true,
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import("@/views/fabricManagement/taskConfig.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/developCycle.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/fabricManagement/fabricSchedule/purchasingdetail.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/fabricManagement/fabricSchedule/purchasingcomplated.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/fabricDevelop.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/fabricManagement/testingList.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/testingConduct.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/testingComplete.vue"),
        hidden: false,
      },
      ...
      // },
      {
        ...
        component: () => import("@/views/fabricManagement/pricingList.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/pricingConduct.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/pricingComplete.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/personList.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/personConduct.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/personComplete.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/fabricManagement/reportForm.vue"),
        hidden: false,
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import("@/views/tagsPrint/applyForPrint.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/tagsPrint/addPrint.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/tagsPrint/editPrint.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/tagsPrint/printDetails.vue"),
        hidden: false,
      },
    ],
  },
  //boss
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "/商品企划/人员配置",
          path: "/boss-bussiness/testFor",
          label: "人员配置",
        },
        component: () => import("@/views/boss-bussiness/list/test.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentTask.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentAuditTask.vue"
          ),
        hidden: false,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentDetail.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentComplated.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentAuditDetail.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningAdjustmentAuditComplated.vue"
          ),
        hidden: true,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningMessageDetail.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/categoryPlanningFollowUp.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/productPlanningFollowUp.vue"
          ),
        hidden: true,
      }, //billingParameterConfiguration
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/parameterConfiguration.vue"
          ),
        hidden: false,
      }, //billingParameterConfiguration
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/brandPlanningFollowUp.vue"
          ),
        hidden: true,
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/planningDelayBilling.vue"
          ),
        hidden: true,
      },
      //categoryDevelopmentprogressAnalysis
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/categoryDevelopmentprogressAnalysis.vue"
          ),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/costDevelopmentProgressAnalysis.vue"
          ),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/boss-bussiness/goodsProject/categoryElementAdjustment.vue"
          ),
        hidden: false,
      },
    ],
    ...
    children: [
      {
        ...
        component: () => import("@/views/qualityManagement/toAcceptList.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/qualityManagement/detectionList.vue"),
        hidden: false,
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/qualityManagement/reviewList.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/qualityManagement/reviewConduct.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/qualityManagement/reviewComplete.vue"),
        hidden: false,
      },
      {
        ...
        component: () => import("@/views/qualityManagement/bigGoods.vue"),
        hidden: false,
      },
      {
