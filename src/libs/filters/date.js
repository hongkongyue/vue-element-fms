...
export const  date=(date, formatString)=>{
  var d = new Date(date)
  var hours = 0
  var month = 0
...
export const singlePrice = (num) => {
   if(num){
        if(String(num).includes('.')){
          ...
          console.log(typeof(num,'9999999'))
         if(num==undefined){
               return ''
         }else if(String(num).indexOf('0')>-1) {
               return num.toFixed(6) 
               //  console.log(num,'000000')
         }else{
               return '' 
         }
